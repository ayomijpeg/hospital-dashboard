...
>
  ...
  <div>
    ...
    <div className="relative">
      ...
      >
        {showPasswords.password ? <Eye className="h-5 w-5 text-gray-400" /> : <EyeOff className="h-5 w-5 text-gray-400" />}
      </button>
    </div>
  </div>
  <div>
    ...
    <div className="relative">
      ...
      <button
        ...
        className="absolute right-3 top-1/2 transform -translate-y-1/2"
      >
        {showPasswords.confirm ? <Eye className="h-5 w-5 text-gray-400" /> : <EyeOff className="h-5 w-5 text-gray-400" />}
      </button>
    </div>
  </div>
</div>
...
<button
  ...
  className={`w-full py-2 px-4 bg-teal-600 text-white rounded-lg transition-all ${loading ? 'opacity-70' : 'hover:bg-teal-700'}`}
>
  {loading ? (
